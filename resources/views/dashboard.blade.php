        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center bg-gray-100 py-10 p-14">
                ...
                <div class="container mx-auto pr-4">
                    <div class="w-72 bg-white max-w-xs mx-auto rounded-sm overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-100 cuursor-pointer">
                        <div class="h-20 bg-blue-500 flex items-center justify-beetween">
                            <p class="mr-0 text-white text-lg pl-5">Upcoming  Appointments</p>
                        </div>
                        <div class="flex justify-beetween px-5 pt-6 mb-2 text-sm text-gray-600">
                            <p> TOTAL </p>
                        </div>
                ...
                <div class="container mx-auto pr-4">
                    <div class="w-72 bg-white max-w-xs mx-auto rounded-sm overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-100 cuursor-pointer">
                        <div class="h-20 bg-blue-500 flex items-center justify-beetween">
                            <p class="mr-0 text-white text-lg pl-5">Client</p>
                        </div>
                        <div class="flex justify-beetween px-5 pt-6 mb-2 text-sm text-gray-600">
                            <p> TOTAL </p>
                        </div>
                            <p class="py-4 text-3xl ml-5">{{ $lawyer->lawyer['patients'] ?? 0}}</p>
                    </div>
                </div>
                ...
                <div class="container mx-auto pr-4">
                    <div class="w-72 bg-white max-w-xs mx-auto rounded-sm overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-100 cuursor-pointer">
                        <div class="h-20 bg-blue-500 flex items-center justify-beetween">
                            <p class="mr-0 text-white text-lg pl-5">Review</p>
                        </div>
                        <div class="flex justify-beetween px-5 pt-6 mb-2 text-sm text-gray-600">
                            <p> TOTAL </p>
                        </div>
